...
2.Category-based news (Business, Sports, Science, etc.)

3.Pagination for navigating between pages

4.Loading spinner while fetching data

5.Responsive UI built with Bootstrap

6.Dynamic document title based on selected category
